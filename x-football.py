    ...
    if not st.session_state.analysis_records:
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "负概率": st.column_config.TextColumn(width=65),
                "主进球": st.column_config.TextColumn(width=65),
                "客进球": st.column_config.TextColumn(width=65),
                "胜赔付": st.column_config.TextColumn(width=65),
                "平赔付": st.column_config.TextColumn(width=65),
                "负赔付": st.column_config.TextColumn(width=65),
                "0球": st.column_config.TextColumn(width=55),
                "1球": st.column_config.TextColumn(width=55),
                "2球": st.column_config.TextColumn(width=55),
                "3球": st.column_config.TextColumn(width=55),
                "4球": st.column_config.TextColumn(width=55),
                "5球": st.column_config.TextColumn(width=55),
                "6球": st.column_config.TextColumn(width=55),
                "7+球": st.column_config.TextColumn(width=55),
                "记录时间": st.column_config.TextColumn(width=120),
